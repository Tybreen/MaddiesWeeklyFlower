...
*/
//* Here
const transitionDay = new Date(2024, 11, 8, 0, 0, 0);
...
//* Here
const quote = `I really miss you!!! I sorry I am not with you this second. I miss you every second of every day! I love you with all my heart! You are sure a great girlfriend! I love you!!! XOXO!!! OOOXXX!!!`;
...
function preload() {
	//* Here
	image1 = loadImage("./Flowers/Week 85.jpg");
	image2 = loadImage("./Flowers/Week 86.jpg");
}
